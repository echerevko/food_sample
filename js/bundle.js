...
function calculator() {
  ...
  function inintLocalSettings(selector, activeClass) {
  ...
  inintLocalSettings('#gender div', 'calculating__choose-item_active');
  inintLocalSettings(
...
function slider({
  ...
  // Slider on the page:
  // 1. Get all items
  // 2. Determine the index for the current slide
  // 3. Writing a function to show our slide and hide others with a slide.The function must provide for the correct movement of the slide
  ...
  // 1st variant how to create slider:
...
`;
  ...
  // 2nd variant how to create slider:
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2022-03-17');
});
